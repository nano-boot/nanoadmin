...
try {
    ...
    // 检查并插入初始数据
    echo "检查初始数据...\n";
    $adminExists = \think\facade\Db::table('na_sys_admin')->where('username', 'admin')->find();
    
    if (!$adminExists) {
        echo "插入初始数据...\n";
        
        // 插入超级管理员
        $adminId = \think\facade\Db::table('na_sys_admin')->insertGetId([
            'username' => 'admin',
        ...
        // 插入超级管理员角色
        $roleId = \think\facade\Db::table('na_sys_role')->insertGetId([
            'code' => 'super_admin',
            'name' => '超级管理员',
        ...
        // 关联管理员和角色
        \think\facade\Db::table('na_sys_admin_role')->insert([
            'admin_id' => $adminId,
            'role_id' => $roleId
        ]);
        echo "管理员角色关联成功\n";
