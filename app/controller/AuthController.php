...
class AuthController
{
    ...
    #[AllowAnonymous(requireToken: false, requirePermission: false, description: '管理员登录')]
    ...
    #[AllowAnonymous(requireToken: false, requirePermission: false, description: '管理员登出')]
    #[DataResponse()]
    ...
    #[AllowAnonymous(requireToken: true, requirePermission: false, description: '当前管理员信息')]
    ...
    #[AllowAnonymous(requireToken: false, requirePermission: false, description: '刷新 Token')]
    ...
    #[AllowAnonymous(requireToken: true, requirePermission: false, description: '当前管理员权限列表')]
    #[DataResponse()]
    ...
    #[AllowAnonymous(requireToken: true, requirePermission: false, description: '当前管理员菜单列表')]
    #[DataResponse()]
    ...
    #[AllowAnonymous(requireToken: false, requirePermission: false, description: '检查 Token 有效性')]
